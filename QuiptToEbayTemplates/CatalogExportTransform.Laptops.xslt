...
<xsl:template match="q:InventoryVirtualResult" mode="CategoryId"><xsl:text>177</xsl:text></xsl:template>
...
<xsl:template match="q:InventoryVirtualResult" mode="render-attributes"><xsl:call-template name="render-attribute"><xsl:with-param name="name">Type</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='NOTEBOOKFORMFACT']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Brand</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:value-of select="q:Catalog/q:Brand/q:Name" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Model</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='MODELNBR']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">MPN</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:value-of select="q:Catalog/q:SKUs/q:SKU[q:Type = 'MPN']/q:Value" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Operating System</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPOS']/q:Value/a:string[1]" />
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Storage Type</xsl:with-param><xsl:with-param name="value"><!--freetext-->
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">SSD Capacity</xsl:with-param><xsl:with-param name="value"><!--freetext-->
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Release Year</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='RELEASEYEAR']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Color</xsl:with-param><xsl:with-param name="value"><xsl:variable name='qColor' select="q:Catalog/q:Attributes/q:Attribute[q:Code='GENERICCOLOR']/q:Value/a:string[1]" />
...
<xsl:variable name="displayPort" select="q:Catalog/q:Attributes/q:Attribute[q:Code='TOTALDSLPRT']/q:Value/a:string[1]" />
<xsl:variable name="dvi" select="q:Catalog/q:Attributes/q:Attribute[q:Code='TOTALDVI']/q:Value/a:string[1]" />
<xsl:variable name="lan" select="q:Catalog/q:Attributes/q:Attribute[q:Code='LANPORT']/q:Value/a:string[1]" />
...
<xsl:variable name="outputFragmentCollection">
	...
	<xsl:if test="$displayPort &gt; 0">
		<data>
			 <xsl:value-of select="$displayPort" />
			 <xsl:text> DisplayPort</xsl:text>
			 <xsl:if test="$displayPort &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	</xsl:if>
	...
	<xsl:if test="$usb2 &gt; 0">
		<data>
			 <xsl:value-of select="$usb2" />
			 <xsl:text> USB 2.0 port</xsl:text>
			 <xsl:if test="$usb2 &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	...
	<xsl:if test="$usb3 &gt; 0">
		<data>
			 <xsl:value-of select="$usb3" />
			 <xsl:text> USB 3.0 port</xsl:text>
			 <xsl:if test="$usb3 &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	...
	<xsl:if test="$usbC &gt; 0">
		<data>
			 <xsl:value-of select="$usbC" />
			 <xsl:text> USB C port</xsl:text>
			 <xsl:if test="$usbC &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
...
</xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Features</xsl:with-param><xsl:with-param name="value"><!--freetext-->
...
<xsl:for-each select="msxsl:node-set($outputFragmentCollection)/*[. != '']">
	<xsl:if test="position() &gt; 1"><xsl:text>|</xsl:text></xsl:if>
	<xsl:value-of select="."/>
</xsl:for-each></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Maximum Resolution</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='MAXRES']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Graphics Processing Type</xsl:with-param><xsl:with-param name="value"><!--freetext, recommendations include 
Dedicated Graphics
...
<xsl:value-of select="msxsl:node-set($map)/item[@code=$gpuType]"/></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Series</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='NOTEBOOKPRODLINE']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Most Suitable For</xsl:with-param><xsl:with-param name="value"><xsl:variable name="qLifestyle" select="q:Catalog/q:Attributes/q:Attribute[q:Code='PCLIFESTYLE']/q:Value/a:string[1]" />

<xsl:variable name="qGraphics" select="q:Catalog/q:Attributes/q:Attribute[q:Code='GPUTYPE']/q:Value/a:string[1]" />

<xsl:choose> 
<xsl:when test="$qLifestyle='Business'">
...
<xsl:when test="$qLifestyle='All-in-One' and $qGraphics = 'Dedicated' ">
<xsl:text>Graphics Design</xsl:text>
</xsl:when>
...
<xsl:when test="$qLifestyle='Education' and $qGraphics = 'Dedicated' ">
<xsl:text>Graphics Design</xsl:text>
</xsl:when>
...
<xsl:text>Casual Computing</xsl:text>
    ...
    </xsl:if></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Unit Quantity</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMWEIGHT']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Unit Type</xsl:with-param><xsl:with-param name="value"><xsl:text>LBS</xsl:text></xsl:with-param></xsl:call-template></xsl:template>
