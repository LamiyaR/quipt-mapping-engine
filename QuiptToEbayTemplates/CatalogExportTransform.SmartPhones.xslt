...
<xsl:template match="q:InventoryVirtualResult" mode="CategoryId"><xsl:text>9355</xsl:text></xsl:template>
...
<xsl:template match="q:InventoryVirtualResult" mode="render-attributes"><xsl:call-template name="render-attribute"><xsl:with-param name="name">Brand</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Brand/q:Name" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Model</xsl:with-param><xsl:with-param name="value"><xsl:variable name='qProdLn' select="q:Catalog/q:Attributes/q:Attribute[q:Code='PHONEPRODLINE']/q:Value/a:string[1]" />


<xsl:choose>

<xsl:when test="contains($qProdLn,'Not Applicable') ">
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='MODELNBR']/q:Value/a:string[1]" />
</xsl:when>

<xsl:otherwise>
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='PHONEPRODLINE']/q:Value/a:string[1]" />
<xsl:text>&#160;</xsl:text>
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='MODELNBR']/q:Value/a:string[1]" />
</xsl:otherwise>


</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Network</xsl:with-param><xsl:with-param name="value"><xsl:variable name='qcellstatus' select="q:Catalog/q:Attributes/q:Attribute[q:Code='LOCKEDUNLOCKED']/q:Value/a:string[1]" />

<xsl:choose>

<xsl:when test="$qcellstatus != 'Unlocked' ">
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='NETWORKPROVIDER']/q:Value/a:string[1]" />
</xsl:when>
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Operating System</xsl:with-param><xsl:with-param name="value"><xsl:variable name ="qphoneos"
select="q:Catalog/q:Attributes/q:Attribute[q:Code='TABOS']/q:Value/a:string[1]" />

<xsl:choose>
<xsl:when test="contains($qphoneos, 'Android') ">
<xsl:text>Android</xsl:text>
</xsl:when>

<xsl:when test="contains($qphoneos, 'FireOS') ">
<xsl:text>Fire OS</xsl:text>
</xsl:when>


<xsl:when test="contains($qphoneos, 'iOS') ">
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Storage Capacity</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='STORSIZE']/q:Value/a:string[1]" />

<xsl:text>GB</xsl:text>
</xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Color</xsl:with-param><xsl:with-param name="value"><xsl:variable name='qColor' select="q:Catalog/q:Attributes/q:Attribute[q:Code='EXACTCOLOR']/q:Value/a:string[1]" />
...
<xsl:otherwise>
  <xsl:value-of select="$qColor"/>
</xsl:otherwise>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Screen Size</xsl:with-param><xsl:with-param name="value"><xsl:variable name ="qphonescreensz"
select="q:Catalog/q:Attributes/q:Attribute[q:Code='SCRNSIZE']/q:Value/a:string[1]" />

<xsl:choose> 
<xsl:when test="$qphonescreensz &gt; 0">
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='SCRNSIZE']/q:Value/a:string[1]" />
<xsl:text>"</xsl:text>
</xsl:when>

</xsl:choose>
</xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">RAM</xsl:with-param><xsl:with-param name="value"><!--FreeText
2GB
1GB
768MB
592MB-->
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Lock Status</xsl:with-param><xsl:with-param name="value"><xsl:variable name="qcellstatus" select="q:Catalog/q:Attributes/q:Attribute[q:Code='LOCKEDUNLOCKED']/q:Value/a:string[1]" />

<xsl:choose>

<xsl:when test ="$qcellstatus !='Unlocked' ">
<xsl:text>Network Locked</xsl:text>
</xsl:when>
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Camera Resolution</xsl:with-param><xsl:with-param name="value"><xsl:variable name="qCamera" select="q:Catalog/q:Attributes/q:Attribute[q:Code='REARCAM']/q:Value/a:string[1]" />


<xsl:choose> 

	<xsl:when test="$qCamera &gt;= 0">
		<xsl:value-of select="concat(format-number($qCamera, '#.#'), ' MP')" />
	</xsl:when>

        <xsl:otherwise><xsl:text>Not Applicable</xsl:text></xsl:otherwise>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Connectivity</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='WIRELESSTECH']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Model Number</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='SPMFG']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Features</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:variable name="displayType" select="q:Catalog/q:Attributes/q:Attribute[q:Code='DSPLYTYPE']/q:Value/a:string[1]" />

<xsl:variable name="resolution" select="q:Catalog/q:Attributes/q:Attribute[q:Code='NATIVERES']/q:Value/a:string[1]" />
...
<xsl:variable name="outputFragmentCollection">
	<data>
		 <xsl:value-of select="concat($screenSize, ' inch ', $resolution, ' ', $displayType, ' display')" />
	</data>
</xsl:variable>
...
<xsl:for-each select="msxsl:node-set($outputFragmentCollection)/*[. != '']">
	...
	<xsl:value-of select="."/>
</xsl:for-each></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Contract</xsl:with-param><xsl:with-param name="value"><xsl:variable name="qcellstatus" select="q:Catalog/q:Attributes/q:Attribute[q:Code='LOCKEDUNLOCKED']/q:Value/a:string[1]" />

<xsl:choose>

<xsl:when test ="$qcellstatus='Locked' ">
<xsl:text>With Contract</xsl:text>
</xsl:when>

<xsl:when test="contains($qcellstatus,'Prepaid') ">
<xsl:text>Prepaid</xsl:text>
</xsl:when>

<xsl:otherwise>
<xsl:text>Without Contract</xsl:text>
</xsl:otherwise>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">MPN</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:SKUs/q:SKU[q:Type = 'MPN']/q:Value" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Item Height</xsl:with-param><xsl:with-param name="value"> <xsl:if test="normalize-space(q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMDIMS']/q:Value/a:string)!=''">
    ...
    </xsl:if></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">SIM Card slot</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='DUALSIM']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Style</xsl:with-param><xsl:with-param name="value"><xsl:text>Bar</xsl:text></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Country/Region of Manufacture</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:CountryOfOrigin/q:Name" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Cellular Band</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='CELLULARNETWORK']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template></xsl:template>
<xsl:template match="q:InventoryVirtualResult" mode="VariantAttributeMapping"><string quiptCode="EXACTCOLOR">Color</string></xsl:template></xsl:stylesheet>