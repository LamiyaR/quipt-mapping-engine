...
<xsl:stylesheet version="1.0" exclude-result-prefixes="msxsl xsi xsd str q i" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:q="http://schemas.quipt.com/api" xmlns:str="http://exslt.org/strings" xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:a="http://schemas.microsoft.com/2003/10/Serialization/Arrays" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
...
<xsl:template match="q:InventoryVirtualResult" mode="CategoryId"><xsl:text>111418</xsl:text></xsl:template>
<xsl:template match="q:InventoryVirtualResult" mode="Condition"><xsl:variable name="certRfb"><xsl:apply-templates select="." mode="certRfb" /></xsl:variable><xsl:variable name="sellerRfb"><xsl:apply-templates select="." mode="sellerRfb" /></xsl:variable></xsl:template>
<xsl:template match="q:InventoryVirtualResult" mode="Filter"><xsl:variable name="includeItem"><xsl:if test="q:Catalog/q:Manufacturer/q:Name = 'Apple'">1</xsl:if></xsl:variable><xsl:value-of select="normalize-space($includeItem)" /></xsl:template>
<xsl:template match="q:InventoryVirtualResult" mode="render-attributes"><xsl:call-template name="render-attribute"><xsl:with-param name="name">Screen Size</xsl:with-param><xsl:with-param name="value"><xsl:text>None</xsl:text></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Processor</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='CPUSERIES']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Processor Speed</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:variable name="cpuSpeed" select="q:Catalog/q:Attributes/q:Attribute[q:Code='CPUSPEED']/q:Value/a:string[1]" />

<xsl:choose> 
	<xsl:when test="$cpuSpeed &lt; 1">
		<xsl:value-of select="concat($cpuSpeed * 1000 , 'MHz')" />
	</xsl:when>

	<xsl:when test="$cpuSpeed &gt;= 1">
		<xsl:value-of select="concat(format-number($cpuSpeed, '0.00'), 'GHz')" />
	</xsl:when>
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">RAM Size</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:variable name="ram" select="q:Catalog/q:Attributes/q:Attribute[q:Code='RAMSIZE']/q:Value/a:string[1]" />

<xsl:choose> 
	<xsl:when test="$ram &lt; 1">
		<xsl:value-of select="concat($ram * 1000 , 'MB')" />
	</xsl:when>

	<xsl:when test="$ram &gt;= 1">
		<xsl:value-of select="concat(format-number($ram, '#.#'), 'GB')" />
	</xsl:when>
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Operating System</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPOS']/q:Value/a:string[1]" />

<xsl:variable name='qOSversion' select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPOSEDITION']/q:Value/a:string[1]" />


<xsl:choose>

<xsl:when test="$qOSversion='Not Applicable'">
</xsl:when>

<xsl:otherwise>
<xsl:text>&#160;</xsl:text>
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPOSEDITION']/q:Value/a:string[1]" />
</xsl:otherwise>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Bundle Listing</xsl:with-param><xsl:with-param name="value"><xsl:text>No</xsl:text></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Storage Type</xsl:with-param><xsl:with-param name="value"><!--freetext, recommendations include:
HDD (Hard Disk Drive)
HDD + SSD
...
<!--freetext-->
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='HDTYPEHWARE']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Hard Drive Capacity</xsl:with-param><xsl:with-param name="value"><!--freetext-->
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Graphics Processing Type</xsl:with-param><xsl:with-param name="value"><!--freetext, recommendations include 
Dedicated Graphics
...
<xsl:variable name="gpuType"
select="q:Catalog/q:Attributes/q:Attribute[q:Code='GPUTYPE']/q:Value/a:string[1]" />


<xsl:variable name="map">
<item code="Dedicated">Dedicated Graphics</item>
<item code="Dedicated">Dedizierte Grafik</item>
<item code="Integrated">Integrated/On-Board Graphics</item>
<item code="Integrated">Integrierte Grafik</item>
<item code="Hybrid">Hybrid Graphics</item>
<item code="Hybrid">Hybrid-Grafik</item>
</xsl:variable>

<xsl:value-of select="msxsl:node-set($map)/item[@code=$gpuType]"/></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Release Year</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='RELEASEYEAR']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Type</xsl:with-param><xsl:with-param name="value"><xsl:text>Desktop</xsl:text></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Model</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='MODELNBR']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">GPU</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='GPUMODEL']/q:Value/a:string[1]" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Form Factor</xsl:with-param><xsl:with-param name="value"><!--freetext-->
...
select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPFORMFACT']/q:Value/a:string[1]" />


<xsl:choose>

<xsl:when test="$formFactor='Small Form Factor'">
<xsl:text>Small Form Factor (SFF)</xsl:text>
</xsl:when>

<xsl:when test="$formFactor='Ultra Small Form Factor (USFF)'">
<xsl:text>Ultra Small Form Factor (USFF)</xsl:text>
</xsl:when>

<xsl:otherwise>
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPFORMFACT']/q:Value/a:string[1]" />
</xsl:otherwise>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Color</xsl:with-param><xsl:with-param name="value"><xsl:variable name='qColor' select="q:Catalog/q:Attributes/q:Attribute[q:Code='GENERICCOLOR']/q:Value/a:string[1]" />

<xsl:choose>

<xsl:when test="$qColor='Grey'">
<xsl:text>Gray</xsl:text>
</xsl:when>

<xsl:otherwise>
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='GENERICCOLOR']/q:Value/a:string[1]" />
</xsl:otherwise>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Brand</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Brand/q:Name" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Series</xsl:with-param><xsl:with-param name="value"><xsl:variable name="quiptproductline" select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPPRODLINE']/q:Value/a:string[1]" />

<xsl:choose>

<xsl:when test="contains($quiptproductline,'Custom/No Brand')">
</xsl:when>

<xsl:otherwise>
<xsl:value-of select="q:Catalog/q:Brand/q:Name" />
<xsl:text>&#160;</xsl:text>
<xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='DESKTOPPRODLINE']/q:Value/a:string[1]" />
</xsl:otherwise>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Most Suitable For</xsl:with-param><xsl:with-param name="value"><xsl:variable name="qLifestyle" select="q:Catalog/q:Attributes/q:Attribute[q:Code='PCLIFESTYLE']/q:Value/a:string[1]" />

<xsl:variable name="qGraphics" select="q:Catalog/q:Attributes/q:Attribute[q:Code='GPUTYPE']/q:Value/a:string[1]" />

<xsl:choose>

<xsl:when test="$qLifestyle='Business' and $qGraphics = 'Dedicated' ">
...
<xsl:when test="$qLifestyle='Home &amp; Student' and $qGraphics = 'Dedicated' ">
<xsl:text>Graphic Design</xsl:text>
</xsl:when>

<xsl:when test="$qLifestyle='Home &amp; Student' and $qGraphics != 'Dedicated' ">
<xsl:text>Engineering Coding</xsl:text>
</xsl:when>

<xsl:when test="$qLifestyle='Gaming'">
<xsl:text>Gaming</xsl:text>
</xsl:when>

<xsl:when test="$qLifestyle='Entertainment'">
<xsl:text>Casual Computing</xsl:text>
</xsl:when>

<xsl:when test="$qLifestyle='Mobile'">
<xsl:text>Casual Computing</xsl:text>
</xsl:when>

<xsl:when test="$qLifestyle='Server'">
<xsl:text>Industrial</xsl:text>
</xsl:when>

</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Connectivity</xsl:with-param><xsl:with-param name="value"><!--freetext-->
<xsl:variable name="dvi" select="q:Catalog/q:Attributes/q:Attribute[q:Code='TOTALDVI']/q:Value/a:string[1]" />
<xsl:variable name="hdmi" select="q:Catalog/q:Attributes/q:Attribute[q:Code='HDMI']/q:Value/a:string[1]" />
<xsl:variable name="headphone" select="q:Catalog/q:Attributes/q:Attribute[q:Code='HDPHNJACK']/q:Value/a:string[1]" />
<xsl:variable name="microphone" select="q:Catalog/q:Attributes/q:Attribute[q:Code='MICPHNJACK']/q:Value/a:string[1]" />
<xsl:variable name="usb2" select="q:Catalog/q:Attributes/q:Attribute[q:Code='USBPRT']/q:Value/a:string[1]" />
<xsl:variable name="usb3" select="q:Catalog/q:Attributes/q:Attribute[q:Code='USBPWR']/q:Value/a:string[1]" />
<xsl:variable name="usbC" select="q:Catalog/q:Attributes/q:Attribute[q:Code='USBCPORTS']/q:Value/a:string[1]" />
<xsl:variable name="vga" select="q:Catalog/q:Attributes/q:Attribute[q:Code='VGA']/q:Value/a:string[1]" />
<xsl:variable name="lan" select="q:Catalog/q:Attributes/q:Attribute[q:Code='LANCOMPAT']/q:Value/a:string[1]" />
<xsl:variable name="pci1x" select="q:Catalog/q:Attributes/q:Attribute[q:Code='AVAILPCIX1']/q:Value/a:string[1]" />
<xsl:variable name="pci8x" select="q:Catalog/q:Attributes/q:Attribute[q:Code='AVAILPCIX8']/q:Value/a:string[1]" />
<xsl:variable name="pci16x" select="q:Catalog/q:Attributes/q:Attribute[q:Code='AVAILPCIX16']/q:Value/a:string[1]" />

<xsl:variable name="ext35Bays" select="q:Catalog/q:Attributes/q:Attribute[q:Code='TOTAL35EXTBAY']/q:Value/a:string[1]" />
<xsl:variable name="int35Bays" select="q:Catalog/q:Attributes/q:Attribute[q:Code='TOTAL35INTBAY']/q:Value/a:string[1]" />
<xsl:variable name="hotswapBays" select="q:Catalog/q:Attributes/q:Attribute[q:Code='TOTALHOTSWAP']/q:Value/a:string[1]" />
<xsl:variable name="totalExpBays" select="q:Catalog/q:Attributes/q:Attribute[q:Code='TOTALEXPBAY']/q:Value/a:string[1]" />

<xsl:variable name="outputFragmentCollection">
	<xsl:if test="$hdmi &gt; 0">
		<data>
			 <xsl:text>HDMI port</xsl:text>
		</data>
	</xsl:if>

	<xsl:if test="$usb2 &gt; 0">
		<data>
			 <xsl:text>USB 2.0</xsl:text>
		</data>
	</xsl:if>
	
	<xsl:if test="$usb3 &gt; 0">
		<data>
			 <xsl:text>USB 3.0</xsl:text>
		</data>
	</xsl:if>

	<xsl:if test="$usbC &gt; 0">
		<data>
			 <xsl:text>USB-C</xsl:text>
		</data>
	</xsl:if>
	
	<xsl:if test="$ext35Bays &gt; 0">
		<data>
			 <xsl:value-of select="$ext35Bays" />
			 <xsl:text> External 3.5&quot; Expansion Bay</xsl:text>
			 <xsl:if test="$ext35Bays &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	</xsl:if>
	<xsl:if test="$int35Bays &gt; 0">
		<data>
			 <xsl:value-of select="$int35Bays" />
			 <xsl:text> Internal 3.5&quot; Expansion Bay</xsl:text>
			 <xsl:if test="$int35Bays &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	</xsl:if>
	<xsl:if test="$hotswapBays &gt; 0">
		<data>
			 <xsl:value-of select="$hotswapBays" />
			 <xsl:text> Hot Swap Bay</xsl:text>
			 <xsl:if test="$hotswapBays &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	</xsl:if>
	<xsl:if test="$totalExpBays &gt; 0">
		<data>
			 <xsl:value-of select="$totalExpBays" />
			 <xsl:text> Total Expansion Bay</xsl:text>
			 <xsl:if test="$totalExpBays &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	</xsl:if>
	...
	<xsl:if test="$pci1x &gt; 0">
		<data>
			 <xsl:value-of select="$pci1x" />
			 <xsl:text> PCIe 1x Expansion Slot</xsl:text>
			 <xsl:if test="$pci1x &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	...
	<xsl:if test="$pci8x &gt; 0">
		<data>
			 <xsl:value-of select="$pci8x" />
			 <xsl:text> PCIe 8x Expansion Slot</xsl:text>
			 <xsl:if test="$pci8x &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	</xsl:if>
	<xsl:if test="$pci16x &gt; 0">
		<data>
			 <xsl:value-of select="$pci16x" />
			 <xsl:text> PCIe 16x Expansion Slot</xsl:text>
			 <xsl:if test="$pci8x &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	...
	<xsl:if test="$dvi &gt; 0">
		<data>
			 <xsl:value-of select="$dvi" />
			 <xsl:text> DVI output</xsl:text>
			 <xsl:if test="$dvi &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	...
	<xsl:if test="$microphone &gt; 0">
		<data>
			 <xsl:value-of select="$headphone" />
			 <xsl:text> Microphone Jack</xsl:text>
			 <xsl:if test="$headphone &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	</xsl:if>
		
	<xsl:if test="$headphone &gt; 0">
		<data>
			 <xsl:value-of select="$headphone" />
			 <xsl:text> Headphone Jack</xsl:text>
			 <xsl:if test="$headphone &gt; 1">
				<xsl:text>s</xsl:text>
			 </xsl:if>
		</data>
	...
	<xsl:if test="$vga &gt; 0">
		<data>
			 <xsl:text>VGA</xsl:text>
		</data>
	</xsl:if>
	
	<xsl:if test="$lan != 'No Wired Ethernet/LAN'">
		<data>
			 <xsl:value-of select="$lan" />
			 <xsl:text> Wired LAN</xsl:text>
		</data>
	</xsl:if>
</xsl:variable>
	...
	</xsl:for-each></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Features</xsl:with-param><xsl:with-param name="value"><!--freetext-->
...
<xsl:for-each select="msxsl:node-set($outputFragmentCollection)/*[. != '']">
	<xsl:if test="position() &gt; 1"><xsl:text>|</xsl:text></xsl:if>
	<xsl:value-of select="."/>
</xsl:for-each></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">MPN</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:SKUs/q:SKU[q:Type = 'MPN']/q:Value" /></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Maximum RAM Capacity</xsl:with-param><xsl:with-param name="value"><xsl:value-of select="q:Catalog/q:Attributes/q:Attribute[q:Code='RAMMAX']/q:Value/a:string[1]" />
<xsl:text> GB</xsl:text></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">SSD Capacity</xsl:with-param><xsl:with-param name="value"><!--freetext-->
...
</xsl:choose></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Item Height</xsl:with-param><xsl:with-param name="value"> <xsl:if test="normalize-space(q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMDIMS']/q:Value/a:string)!=''">
      <xsl:value-of select="normalize-space(substring-before(q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMDIMS']/q:Value/a:string,'x'))"/>
    </xsl:if></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Item Length</xsl:with-param><xsl:with-param name="value"><xsl:if test="normalize-space(q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMDIMS']/q:Value/a:string)!=''">
      <xsl:value-of select="normalize-space(substring-before(substring-after(q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMDIMS']/q:Value/a:string,'x'),'x'))"/>
    </xsl:if></xsl:with-param></xsl:call-template><xsl:call-template name="render-attribute"><xsl:with-param name="name">Item Width</xsl:with-param><xsl:with-param name="value"><xsl:if test="normalize-space(q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMDIMS']/q:Value/a:string)!=''">
      <xsl:value-of select="normalize-space(substring-after(substring-after(q:Catalog/q:Attributes/q:Attribute[q:Code='ITEMDIMS']/q:Value/a:string,'x'),'x'))"/>
    </xsl:if></xsl:with-param></xsl:call-template></xsl:template>
<xsl:template match="q:InventoryVirtualResult" mode="VariantAttributeMapping" /></xsl:stylesheet>